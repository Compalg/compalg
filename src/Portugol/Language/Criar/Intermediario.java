...
public class Intermediario {
    ...
    private Subrutine Inicio;
    public Subrutine getInicio(){
        return Inicio;
    }    
    /**
    ...
    protected void Construir(String programa)throws LanguageException{
      ...
      //    programa = obficheiro.getPrograma();
        ...
        while (st.hasMoreTokens()) {
            ...
            instruction = rutina.RemoveComentarios(instruction);
      ...
      bill++;  }//fim da lista seguida
        ...
        ExpandFluxogram.ExpandNodes( rutina , rutina.memory);
...
//=============================================================================
//    public   String RemoveComentarios(Subrutina rutina, String str){
